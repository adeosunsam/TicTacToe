...
namespace TicTacToe.UI
{
	...
	public class GamePresenter : MonoBehaviour
	{
		...
		private void InitializeGame()
		{
			...
			{
				aiPlayer = new MinimaxAI(winChecker, aiDifficulty);
			}
			...
			GameManager.Instance.AchievementManager?.OnGameStarted(gameMode);
		}
		...
		private void HandleCellPlayed(int cellIndex, int player)
		{
			...
			GameManager.Instance.AchievementManager?.OnCellPlayed(gameController.GetBoard(), player, PLAYER_O);
		}
		...
		private void HandleWin(int player, int winLine)
		{
			...
			GameManager.Instance.AchievementManager?.OnPlayerWin(player, gameMode, aiDifficulty, gameController.GetBoard());

			// Track round completion for friend games
			GameManager.Instance.AchievementManager?.OnRoundCompleted(gameMode);
		...
		private void HandleDraw()
		{
			...
			GameManager.Instance.AchievementManager?.OnDraw();
		...
		private void HandleBoardReset()
		{
			...
			// Reset achievement tracking for the new round
			GameManager.Instance.AchievementManager?.OnBoardReset();
		...
		public void InitializeWithSettings(GameMode mode, AIDifficulty? difficulty = null)
		{
			UnsubscribeFromGameEvents();
			gameMode = mode;
